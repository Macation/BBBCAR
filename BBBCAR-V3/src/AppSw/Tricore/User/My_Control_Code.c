...
extern key_t Key[];
extern pid_param_t Servo_Loc_PID;           //舵机位置式PID配合横向误差
...
float Motor2_IncPID=0;                  //电机速度环
float Motor_DirPId=0;                   //电机转向环
volatile sint16 Battery;                //电池电量ADC
volatile float Current_Speed1=0;        //单位m/s
volatile float Current_Speed2=0;
volatile sint16 LPulse;                 //左编码器脉冲
volatile sint16 YPulse;                 //右编码器脉冲
